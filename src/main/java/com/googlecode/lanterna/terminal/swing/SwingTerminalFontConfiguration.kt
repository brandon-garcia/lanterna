 ...
 */
(useAntiAliasing: Boolean, boldMode: AWTTerminalFontConfiguration.BoldMode, vararg fontsInOrderOfPriority: Font) : AWTTerminalFontConfiguration(useAntiAliasing, boldMode, fontsInOrderOfPriority) {
	companion object {
		/**
		...
		val default: SwingTerminalFontConfiguration
			get() = newInstance(*AWTTerminalFontConfiguration.filterMonospaced(*AWTTerminalFontConfiguration.selectDefaultFont()))
