...
@JvmOverloads constructor(
	...
	scrollController: TerminalScrollController = TerminalScrollController.Null()) : Panel(), IOSafeTerminal {
	 ...
	 */
	@Synchronized override fun paint(componentGraphics: Graphics?) {
	 ...
	 * @param componentGraphics `Graphics` object to use when drawing the component
	 */
	@Synchronized override fun update(componentGraphics: Graphics) {
