...
public class DrawImageTest {
    public static void main(String[] args) throws IOException {
        ...
        textGraphics.drawRectangle(
				TerminalPosition.Companion.getTOP_LEFT_CORNER(),
                new TerminalSize(5, 5),
                imageCharacter.withBackgroundColor(TextColor.ANSI.RED));
        textGraphics.drawRectangle(
				TerminalPosition.Companion.getOFFSET_1x1(),
        ...
        screenGraphics.setBackgroundColor(TextColor.Indexed.Companion.fromRGB(50, 50, 50));
        screenGraphics.fill(' ');
        screenGraphics.drawImage(TerminalPosition.Companion.getOFFSET_1x1(), image);
        screenGraphics.drawImage(new TerminalPosition(8, 1), image, TerminalPosition.Companion.getTOP_LEFT_CORNER(), image.getSize().withRelativeColumns(-4));
        screenGraphics.drawImage(new TerminalPosition(10, 1), image, TerminalPosition.Companion.getTOP_LEFT_CORNER(), image.getSize().withRelativeColumns(-3));
        screenGraphics.drawImage(new TerminalPosition(13, 1), image, TerminalPosition.Companion.getTOP_LEFT_CORNER(), image.getSize().withRelativeColumns(-2));
        screenGraphics.drawImage(new TerminalPosition(17, 1), image, TerminalPosition.Companion.getTOP_LEFT_CORNER(), image.getSize().withRelativeColumns(-1));
        ...
        screenGraphics.drawImage(new TerminalPosition(1, 7), image, TerminalPosition.Companion.getTOP_LEFT_CORNER(), image.getSize().withRelativeColumns(10));

        //0 size should draw nothing
        screenGraphics.drawImage(new TerminalPosition(8, 7), image, TerminalPosition.Companion.getTOP_LEFT_CORNER(), TerminalSize.Companion.getZERO());
